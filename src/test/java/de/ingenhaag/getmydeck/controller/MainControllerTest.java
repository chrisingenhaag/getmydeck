...
class MainControllerTest implements JUnit5ValidationFileAssertions {
  ...
  void testGetApiV2(Region region, Version version) throws Exception {
    ...
    //assertWithFileWithSuffix(objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(infoResponse), region.toString()+version.getVersion().toString(), JSON);
  }
